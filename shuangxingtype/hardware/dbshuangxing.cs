...
namespace doublestartyre.hardware
{
    class dbdoublestar
    {
        ...
        public static string M_str_sqlcon = "server=(local);database=doublestar;integrated security=SSPI";
        ...
        //public static string M_str_sqlcon = "server=192.168.8.223;database=db_shengtong;uid=sa;pwd=!@#123qwe";
